...
export default function SignupForm() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            const response = await axios.post('/api/vendor/signup', formData)
            if (!response) {
            ...
            if (response.data?.success) {
                localStorage.setItem('vendorSignupData', JSON.stringify(formData));
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                                ...
                                Owner's name <span className="text-red-500 ml-1">*</span>
                            </label>
                            <input
                                type="text"
                                name="ownerName"
                                ...
                                className={`w-full px-4 py-3 text-gray-600 border ${errors.ownerName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition`}
                    ...
                    <div className='mt-2 text-center text-gray-700'>
                        Already have an account!! Please <button onClick={() => {
                            signIn('google')
                        }} className='text-indigo-600 hover:text-indigo-700 cursor-pointer font-medium'> SignIn</button>
                    </div>
                </div>
            </div>
        </div>
