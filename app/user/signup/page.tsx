...
export default function SignupForm() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            console.log("error in user signup:", error.response?.data || error.message);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="max-w-md mx-auto">
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Create new user account</p>
                    </div>

                    {submitSuccess && (
                        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-green-800 text-center font-medium">✓ User Account created successfully!</p>
                        </div>
                    )}
